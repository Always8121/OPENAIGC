...
# route setting 路径设置
IMAGE_DIR = "/kaggle/input/ustudent"  # Replace it with your own path替换为你自己的路径
image_files = [os.path.join(IMAGE_DIR, f) for f in os.listdir(IMAGE_DIR) if f.endswith('.jpg')]

def product_data_iterator():
  """Iterator over images in the product folder."""
...
# Run the predictions and display the results运行预测并显示结果
print("Model predictions for product images")
html_out = ""
for image, caption in make_predictions(product_data_iterator(), batch_size=1):
  html_out += render_example(image, caption)
display(HTML(html_out))
